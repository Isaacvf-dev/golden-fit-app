...
export default function Generator() {
  ...
  const [style, setStyle] = useState("individual");
  ...
  return (
    ...
    >
        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={`bg-slate-950 border  py-3 rounded-lg duration-200 hover:border-amber-600 ${
      ...
      />
      <div
        className="bg-slate-950 border border-solid border-amber-400 rounded-lg flex flex-col"
            ...
            {(style === "individual"
              ...
              return (
                <button
                  ...
                  className={`hover:text-amber-400 duration-200 ${muscles.includes(muscleGroup) ? 'text-amber-400' : ''}`}
